...
const Card = ({ item }) => {
  const categoryStyles = {
    ...
    Breakfast: { backgroundColor: "#efedfa", color: "#3c388f" },
    Lunch: { backgroundColor: "#e8f5fa", color: "#397a9e" },
    Desserts: { backgroundColor: "#f0f5c4", color: "#59871f" },
    Sides: { backgroundColor: "#feefc9", color: "#d16400" },
    Dinks: { backgroundColor: "#ffeae3", color: "#f0493e" },
  ...
  return (
    <div className="container mx-auto flex justify-center md:justify-start ">
      <div className="max-w-sm">
        <div className="bg-white relative shadow-lg hover:shadow-lg transition duration-500 rounded-lg">
          <img
          ...
          <div className="py-6 px-5 rounded-lg bg-white">
            <Link to={`/items/${item._id}`}>
              <h1
                className="text-gray-700 font-bold text-2xl mb-8
