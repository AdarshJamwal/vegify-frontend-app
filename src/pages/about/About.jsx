  ...
  return (
    <section className='px-6 lg:px-12 py-20'>
      ...
      <p className='text-center sm:w-1/2 mx-auto mb-20'>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Vero dolorum iusto, aut soluta cum sint accusantium!
      </p>
      <article
      ...
      <div className='container mx-auto px-6 py-40'>
        <div className='flex flex-col md:flex-row items-center justify-between relative w-full h-auto md:h-64 bg-white shadow-2xl rounded-lg p-8'>
          <div className='w-full md:w-8/12 text-2xl'>
            ...
            <span className='flex'>We are a team of developers with hundreds of hours spent coding, we create professional web apps</span>
          </div>
